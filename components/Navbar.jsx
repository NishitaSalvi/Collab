...
const Navbar = () => {
  ...
  return (
    <>
      <nav className='navbar bg-gradient-to-r from-bg-#09090b text-white flex justify-between px-5 h-12 sticky top-0 z-50 items-center'>
        <Link href="/" >
          <div className="logo font-bold text-lg flex justify-center items-center">
            CoTask <img width={45} className="invert mix-blend-screen" src="/images/nebula.gif" alt="" />
          </div>
        </Link>
        <div className='relative'>
          {session && <>
            <button
              ...
              type="button"
            >
              <img width={20} height={10} src="/images/menu.png" alt="" />
            </button>
        ...
        <button className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2 text-center flex justify-center items-center" onClick={()=>{signOut()}}>LogOut</button>

        <button className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2 text-center flex justify-center items-center" onClick={()=>{signIn()}}>signIn</button>
      </nav>
    </>
  )
}
